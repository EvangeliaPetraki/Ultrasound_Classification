...
folder = 'C:/Users/Christos/OneDrive/Christos Files/Current archive/Evangelia Petraki Thesis/Dataset Collection/1 Normal Heart/*'
# folder = 'C:/Users/Christos/OneDrive/Christos Files/Current archive/Evangelia Petraki Thesis/Dataset Collection/3 MVD with TCR/*'
# folder = 'C:/Users/Christos/OneDrive/Christos Files/Current archive/Evangelia Petraki Thesis/Dataset Collection/2 MVD without TCR/*'
...
#         messagebox.showinfo("Confirmation", f"Selected file: {selected_path}")
#         root.quit()
...
#         frame_n = random.randint(0,vid.shape[0])
#         frame = vid[frame_n].astype(np.uint8)
...
#     btn_confirm.pack(side=tk.TOP)

#     btn_next = tk.Button(root, text="Next", command=on_next)
#     btn_next.pack(side=tk.RIGHT)

#     btn_next_frame = tk.Button(root, text="Next Frame", command=on_next_frame)
#     btn_next_frame.pack(side=tk.BOTTOM)

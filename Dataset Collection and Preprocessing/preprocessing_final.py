...
def preprocessing_all(video_path, label):
    ...
    label = 'MVD without TCR_20'
    # label = 'Normal Heart_20'
    # label = "MVD with TCR_20"
    ...
    num_frames = vid.shape[0]
    num_fr_to_select = math.ceil(num_frames *0.2)

    selected_frames = random.sample(range(num_frames) , num_fr_to_select)
    ...
    print('Finished 20% of frames preprocessing')

...
folder_path = '/home/e/epetrb/model_eval/eval_dataset_3/*'
...
def voting(num_frames, MVD_TCR, MVD_NO_TCR, NORMAL, label, correct_sq, all_preds_sq, all_targets_sq, confidences):
    ...
    return MVD_TCR, MVD_NO_TCR, NORMAL, final_result, all_preds_sq, all_targets_sq, correct_sq, highest_confidence_frame, neighboring_frames
...
def process_video(video_path, transform, label, all_preds, all_targets, correct, total, correct_sq, all_preds_sq, all_targets_sq):
  ...
  #counters for frame predictions
    MVD_TCR=0
    MVD_NO_TCR=0
    NORMAL =0
    ...
    MVD_TCR, MVD_NO_TCR, NORMAL, final_result, all_preds_sq, all_targets_sq, correct_sq, highest_confidence_frame, neighboring_frames = voting(num_frames, MVD_TCR, MVD_NO_TCR, NORMAL, label, correct_sq, all_preds_sq, all_targets_sq, confidences)

    # video_predictions = majority_voting(frame_predictions)
    return MVD_TCR, MVD_NO_TCR, NORMAL, final_result,all_preds, all_targets, correct, total, all_preds_sq, all_targets_sq, correct_sq, highest_confidence_frame, neighboring_frames

if __name__ == '__main__':

    m=0

    network.load_state_dict(torch.load("/home/e/epetrb/model_eval/models/3_class_30ep0.001.pth", map_location=torch.device(device))) 
    ...
    for video_path in glob.glob(folder_path):
        ...
        MVD_TCR, MVD_NO_TCR, NORMAL, video_prediction, all_preds, all_targets, correct, total, all_preds_sq, all_targets_sq, correct_sq, highest_confidence_frame, neighboring_frames = process_video(video_path, valTransform, label, all_preds, all_targets, correct, total, correct_sq, all_preds_sq, all_targets_sq)
    ...
    precision_sq, recall_sq, f1_sq, bal_accuracy_sq, specificity_sq, cm_sq = calculate_metrics(all_preds_sq, all_targets_sq, num_classes=3)
